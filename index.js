...
// ✅ FIX: Express/router safe preflight (NO "*")
app.options(/.*/, cors());

// ---------------- Firebase Admin (from ENV) ----------------
// Vercel Env: FIREBASE_SERVICE_ACCOUNT = JSON string of your firebase admin key
...
// ---------------- Env checks ----------------
if (!process.env.DB_URI) console.error("❌ DB_URI missing in env");
if (!process.env.JWT_SECRET) console.error("❌ JWT_SECRET missing in env");
...
// ✅ Local run support (so nodemon works)
